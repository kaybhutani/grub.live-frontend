...
import { updateMenu } from "../../../reducers/EditMenu.reducers";
...
let mapDispatchFromProps = (dispatch) => {
  return {
    updateMenu: (newMenu) => updateMenu(newMenu),
  };
};
...
export default connect(mapStateToProps, mapDispatchFromProps)(RestaurantDetails);
